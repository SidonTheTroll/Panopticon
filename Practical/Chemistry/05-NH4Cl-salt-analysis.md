...
| 2. | Salt + conc. $H_2SO_4 + \Delta$ | Colorless gas with pungent smell evolved. A glass rod moistened with $NH_4OH$ is held over the mouth of test tube and dense fumes are formed. | $Cl^-$ may be present | 
| 3. | Salt + $Cu$-turnings + conc. $H_2SO_4 + \Delta$ | No reddish brown gas evolved | $NO_3^-$ absent | 
| 4. | Chromyl-chloride test: Salt + $K_2Cr_2O_7$ + conc. $H_2SO_4 + \Delta$ | Reddish colored gas evolved. Passing the gas through $NaOH$ solution turns in yellow. | $Cl^-$ confirmed | 
...
| S. No. | Experiment | Observation | Inference | 
|:-:|-|-|:-:|
| 1. | Salt solution + $AgNO_3$ solution | A curdy white ppt. is formed which is insoluble in dil $HNO_3$ but soluble in $NH_4OH$ solution | $Cl^-$ confirmed | 
| 2. | Salt solution + $BaCl^2$ solution | No ppt. | $CO_3^{2-}, SO_4^{2-}$ absent |
...
|-|:-:|:-:|
| Salt solution + sodium cobaltinitrate solution | Yelllow ppt. formed | $K^+$ or $NH_4^+$ present | 
