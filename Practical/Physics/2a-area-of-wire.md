...
4. The wore is introduced between the plane face A and B and the milled head is turned always in one direction till the faces A and B just held. With gentle pressure only, the wire is introduced. Too much pressing may alter the diameter of the wire. 
...
$Cross section area = \frac{22}{7} \times \frac{4.13^2}{4} = 13.40 \text{mm}^2$

## Result 
From the above experiment we get the cross-section area of the given wire to be $13.40 mm^2$
